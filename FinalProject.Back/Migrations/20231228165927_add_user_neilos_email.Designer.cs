...
namespace FinalProject.Back.Migrations
{
    ...
    [Migration("20231228165927_add_user_neilos_email")]
    partial class add_user_neilos_email
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 4,
                            Address = "Nea smirni",
                            CreatedAt = new DateTime(2023, 12, 28, 18, 59, 27, 135, DateTimeKind.Local).AddTicks(4263),
